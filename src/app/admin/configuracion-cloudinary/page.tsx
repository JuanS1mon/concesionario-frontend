...
export default function ConfiguracionCloudinary() {
  ...
  const loadConfiguracion = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/configuracion-cloudinary`, { headers });
      if (response.ok) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/configuracion-cloudinary`, {
        method: 'POST',
        headers,
