        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-md">
          <div className="px-4 py-5 sm:px-6">
            <h3 className="text-lg leading-6 font-medium text-gray-900">
              Lista de Cotizaciones ({cotizaciones.length})
            </h3>
            <p className="mt-1 max-w-2xl text-sm text-gray-500">
              Solicitudes de cotización de clientes interesados en los autos
            </p>
          </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {cotizaciones.map((cotizacion) => (
                  <tr key={cotizacion.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {cotizacion.auto?.marca?.nombre} {cotizacion.auto?.modelo?.nombre} {cotizacion.auto?.anio}
                    </td>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500 max-w-xs truncate">
                      {cotizacion.mensaje || 'Sin mensaje'}
                    </td>
                  </tr>
                ))}
              </tbody>
