          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="flex flex-col">
              ...
              <div className="p-4 lg:p-6 flex flex-col bg-gray-50">
                <div className="relative rounded-2xl overflow-hidden shadow-lg bg-white h-[45vh] lg:h-[60vh] mb-4">
                  <Image
            ...
            <div className="lg:w-80 bg-white p-4 lg:p-6 lg:border-l border-gray-200">
            {/* Precio Premium */}
